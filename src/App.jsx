  ...
  return(
    ...
    <div style={{background:'black'}}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center',margin: '30px' }}>
        <img src={level >= 100 ?"/picture/เด้งหมู.jpg":"/picture/หมูเด้งอิอิ.jpg"} alt="หมูเด้ง" style={{ width: calculateImageSize(),
            height: 'auto',
      ...
      <button className="square"><img src="/picture/แตโมแตโมแตโม.jpg" alt="แตงโม" style={{ width: '100px', height: '100px' }}  
      onClick={() => feedAnimal('watermelon')}/></button>
      <button className="square"><img src="/picture/ฟักทวง.jpg" alt="ฟักทอง" style={{ width: '100px', height: '100px' }} 
      onClick={() => feedAnimal('pumpkin')}/></button>
      <button className="square"><img src="/picture/องุ่นอิอิ.jpg" alt="องุ่น" style={{ width: '100px', height: '100px' }} 
